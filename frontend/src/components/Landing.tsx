...
.vc-landing .nav-in{display:flex; align-items:center; justify-content:space-between; height:60px;}
...
.vc-landing section{padding:72px 0;}
.vc-landing .sec-head{max-width:60ch; margin-bottom:40px;}
